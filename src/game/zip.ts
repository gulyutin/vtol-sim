/*
 * ZIP-архив без сжатия (store): кадры JPEG и так сжаты. Имена — UTF-8 (флаг 0x0800), без
 * ZIP64 — до 4 ГБ и 65 535 файлов, чего для кадров одной съёмки с запасом хватает.
 */
...
export interface ZipEntry {
  name: string;
  data: Uint8Array;
  /** Время изменения; по умолчанию — сейчас. */
  date?: Date;
}
...
/** Собрать архив: части по порядку (заголовок, данные, …, каталог) — для Blob без лишней копии. */
export function zipParts(entries: readonly ZipEntry[]): Uint8Array[] {
