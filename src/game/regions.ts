...
const KUTURCHIN: LocationSpec = {
  ...
  search: {
    ...
    briefing:
      'Двое ушли за ягодой и не вернулись к ночи. Вероятный район — таёжный склон к югу от долины Кутурчина, около 0,9 × 0,9 км, выше — курумник и гольцы. Облететь район с тепловизором и отметить найденных людей. Медведи, волки, лоси и олени тоже тёплые — отличайте их по размеру, форме и повадке.',
    area: [
      { lat: 54.886, lon: 94.153 },
      { lat: 54.894, lon: 94.153 },
      { lat: 54.894, lon: 94.167 },
      { lat: 54.886, lon: 94.167 },
    ],
