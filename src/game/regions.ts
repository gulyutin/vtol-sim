...
const KUTURCHIN: LocationSpec = {
  ...
  // Зона патрулирования — тайга к югу и востоку от посёлка, 530–1000 м: гольцы с их потоками западнее.
  fire: {
    title: 'Лесопожарный патруль',
    briefing:
      'Сухая гроза прошла над Белогорьем ночью — в тайге дымы. Облететь зону патрулирования 7,7 × 7,7 км к югу и востоку от посёлка. Дым виден за километры: доложить о нём кнопкой «Дым» и щелчком по столбу в 3D-виде. Подойдя, подтвердить очаг тепловизором и отметить огневые точки: тлеющие места внутри гари, очаги переброса за кромкой и одиночные тлеющие деревья — у них дыма почти нет, их видно только в тепловом кадре. Дым тепловизор просвечивает. Нагретый солнцем курумник и зимовье с топящейся печью тоже тёплые.',
    area: [
      { lat: 54.88, lon: 94.19 },
      { lat: 54.95, lon: 94.19 },
      { lat: 54.95, lon: 94.31 },
    ...
    route: [
      { lat: 54.925, lon: 94.2, heightAglM: 250 },
      { lat: 54.895, lon: 94.205, heightAglM: 250 },
      { lat: 54.885, lon: 94.25, heightAglM: 250 },
      { lat: 54.895, lon: 94.3, heightAglM: 250 },
      { lat: 54.94, lon: 94.3, heightAglM: 250 },
      { lat: 54.945, lon: 94.25, heightAglM: 250 },
    ],
  },
  survey: {
...
export const REGION_PRESETS: readonly RegionPreset[] = [
  ...
  { id: 'kuturchin', title: 'Кутурчинское Белогорье', hint: 'Тайга и гольцы Восточного Саяна до 1640 м: поиск людей и лесопожарный патруль с тепловизором; площадка в долине, 540 м', location: KUTURCHIN },
