...
export const PROFILE: Profile = {
  ...
  location: {
    ...
    search: {
      title: 'Поиск грибника в лесу',
      briefing:
        'Грибник ушёл в лес неподалёку от аэродрома и не вернулся. Вероятный район — лес в 3–4 км к западу от аэродрома, около 0,9 × 0,9 км. Облететь район с тепловизором и отметить найденного человека. Лоси и косули тоже тёплые — отличайте их по размеру и форме.',
      area: [
        { lat: 54.796, lon: 37.593 },
        { lat: 54.804, lon: 37.593 },
        { lat: 54.804, lon: 37.607 },
        { lat: 54.796, lon: 37.607 },
      ],
      // Подмосковье: медведей нет, волки редки — лоси и косули.
      animals: { moose: 2, deer: 3 },
    },
    date: '2026-06-20',
    utcOffsetH: 3,
    windSpeedMs: 4,
